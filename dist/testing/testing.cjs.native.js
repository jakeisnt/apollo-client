...
var ObservableQuery = (function (_super) {
    ...
    ObservableQuery.prototype.reportError = function (error, variables) {
        var errorResult = tslib.__assign(tslib.__assign({}, this.getLastResult()), { error: error, errors: error.graphQLErrors, networkStatus: NetworkStatus.error, loading: false });
...
var MockLink = (function (_super) {
    ...
    MockLink.prototype.normalizeMockedResponse = function (mockedResponse) {
        ...
        __DEV__ ? tsInvariant.invariant(queryWithoutConnection, "query is required") : tsInvariant.invariant(queryWithoutConnection, 35);
...
var MockedProvider = (function (_super) {
    ...
    MockedProvider.prototype.render = function () {
        ...
        return React__namespace.isValidElement(children) ? (React__namespace.createElement(ApolloProvider, { client: this.state.client }, React__namespace.cloneElement(React__namespace.Children.only(children), tslib.__assign({}, childProps)))) : null;
    };
